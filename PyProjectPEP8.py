...
def Make(TottalProfit, prod):
    ...
    while prod:
        try:
            with open('EveryProduct.txt', 'r') as f:
                pass
        except IOError:
...
def main():
    act = input()
    while act != 'Add' and act != 'New' and act != '1' and
    act != '2' and act != '3' and act != '4':
        cls()
        act = input('Invalid input! Try again!')
    while act == 'Add' or act == 'New' or act == '1' or
    act == '2' or act == '3' or act == '4':
        if act == 'Add':
            AddProducts()
            cls()
        if act == 'New':
        ...
        if act == '1' or act == '2' or act == '3' or act == '4':
            print(MakeByNum(act, input('Enter $\n'), input('Enter calorie\n')))
        act = input()
